...
Phase 2 will consist of extending the team's predictive model into an agentic AI system where multiple specialized agents work together to interpret risk, retrieve clinical evidence, and support decisions. This phase, built independently, moves the project from prediction toward real-world clinical decision support. Refer to Phase 2 section at the bottom of this page for additional details and access a few mockup views of the User Experience interface.
...
As a first step in phase 2, a few mockup views of the 'CardioAssist' desktop/web app is now available and can be accessed by clicking the link below.  
