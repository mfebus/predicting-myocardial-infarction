...
def plot_outlier_boxplot(df, cols=("_LCSYSMK", "_LCSYQTS", "LCSNUMCG"),
                         savepath="eda_outlier_boxplot.png"):
...
def plot_age_health_interaction(df, savepath="eda_age_health_interaction.png"):
...
def plot_mi_by_comorbidity(df,
                           comorbid_cols=("DIABETE4", "CVDSTRK3", "CHCCOPD3",
                                          "CHCKDNY2", "HAVARTH4"),
                           savepath="eda_mi_by_condition.png"):
...
def plot_sensitivity(res, selected=20, stable_start=5,
                     savepath="sensitivity_min_samples_leaf.png"):
